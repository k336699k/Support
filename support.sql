...
-- Дамп структуры для таблица support.customers
...
-- Дамп структуры для таблица support.inquiries
...
-- Дамп структуры для таблица support.topics
...
-- Дамп структуры для таблица support.users
